 ...
 *      Accepted values:<br>
 *      - VDP_DMA_VRAM (for VRAM transfer).<br>
 *      - VDP_DMA_CRAM (for CRAM transfer).<br>
 *      - VDP_DMA_VSRAM (for VSRAM transfer).<br>
 *  \param from
 *      Source address.
 *  \param to
 *      Destination address.
