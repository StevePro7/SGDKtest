 ...
 */
u16 BMP_flip(u16 async) { return 0; }
 ...
 */
u8*  BMP_getWritePointer( u16 x, u16 y ) { return 0; }
/**
 *  \brief
 ...
 */
u8*  BMP_getReadPointer(u16 x, u16 y) { return 0; }
 ...
 */
u16  BMP_hasFlipRequestPending() { return 0; }
/**
 *  \brief
 ...
 */
u16  BMP_hasFlipInProgess() { return 0; }
/**
 *  \brief
 ...
 *  \see #BMP_setPixel
 */
u8   BMP_getPixel(u16 x, u16 y) { return 0; }
/**
 *  \brief
 ...
 */
u8   BMP_getPixelFast(u16 x, u16 y) { return 0; }
/**
 *  \brief
 ...
 */
u16   BMP_clipLine(Line *l) { return 0; }
/**
 *  \brief
 ...
 */
u16 BMP_isPolygonCulled(const Vect2D_s16 *pts, u16 num) { return 0; }
/**
 *  \brief
 *      Draw a polygon.<br>
 *      The polygon points should be defined in clockwise order.<br>
 ...
 */
u16 BMP_drawPolygon(const Vect2D_s16 *pts, u16 num, u8 col) { return 0; }
 ...
 */
u16 BMP_drawBitmap(const Bitmap *bitmap, u16 x, u16 y, u16 loadpal) { return 0; }
/**
 *  \brief
 ...
 */
u16 BMP_drawBitmapScaled(const Bitmap *bitmap, u16 x, u16 y, u16 w, u16 h, u16 loadpal) { return 0; }
