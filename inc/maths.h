...
/**
 *  \brief
 *      Compute and return the result of the subtraction of val2 from val1 (fix32).
 */
...
/**
 *  \brief
 *      2x2 Matrices structure - f16 (fix16) type.<br>
...
/**
 *  \brief
 *      3x3 Matrices structure - f16 (fix16) type.<br>
...
/**
 *  \brief
 *      4x4 Matrices structure - f16 (fix16) type.<br>
 ...
 *      Value to convert.
 */
u32 intToBCD(u32 value) { return 0; }

/**
 *  \deprecated
 *      Use #getApproximatedDistance(..) instead.
 */
u32 distance_approx(s32 dx, s32 dy) { return 0; }
/**
 *  \brief
 ...
 *      delta Y.
 */
u32 getApproximatedDistance(s32 dx, s32 dy) { return 0; }
/**
 *  \brief
 ...
 */
s32 getApproximatedLog2(s32 value) { return 0; }
/**
 *  \brief
 ...
 */
u16 getLog2Int( u32 value ) { return 0; }
