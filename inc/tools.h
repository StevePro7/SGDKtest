 ...
 */
Bitmap *allocateBitmap( const Bitmap *bitmap ) { return NULL; }
/**
 *  \brief
 ...
 */
Bitmap *allocateBitmapEx(u16 width, u16 heigth) { return NULL; }
/**
 *  \brief
 ...
 */
TileSet *allocateTileSet(const TileSet *tileset) { return NULL; }
/**
 *  \brief
 ...
 */
TileSet *allocateTileSetEx( u16 numTile ) { return NULL; }
/**
 *  \brief
 ...
 */
Map *allocateMap(const Map *map) { return NULL; }
/**
 *  \brief
 ...
 */
Map *allocateMapEx(u16 width, u16 heigth) { return NULL; }
/**
 *  \brief
 ...
 */
Image *allocateImage(const Image *image) { return NULL; }
 ...
 *      <i>NULL</i> is returned if there is not enough memory to store the unpacked bitmap.
 */
Bitmap *unpackBitmap(const Bitmap *src, Bitmap *dest) { return NULL; }
/**
 *  \brief
 ...
 *      <i>NULL</i> is returned if there is not enough memory to store the unpacked tiles.
 */
TileSet *unpackTileSet(const TileSet *src, TileSet *dest) { return NULL; }
/**
 *  \brief
 ...
 *      <i>NULL</i> is returned if there is not enough memory to store the unpacked map.
 */
Map *unpackMap(const Map *src, Map *dest) { return NULL; }
/**
 *  \brief
 ...
 *      <i>NULL</i> is returned if there is not enough memory to store the unpacked image.
 */
Image *unpackImage(const Image *src, Image *dest) { return NULL; }
 ...
 *      Unpacked size.
 */
u32 unpack( u16 compression, u8 *src, u8 *dest ) { return 0; }
 ...
 *      Unpacked size.
 */
u32 aplib_unpack( u8 *src, u8 *dest ) { return 0; }
/**
 *  \brief
 ...
 *      Unpacked size.
 */
u32 lz4w_unpack( const u8 *src, u8 *dest ) { return 0; }
 ...
 */
int zlib_unpack( void *dest, const unsigned outLen, const void *src, const unsigned srcLen ) { return 0; }
