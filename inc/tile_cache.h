 ...
 */
s16 TC_alloc( TileCache *cache, TileSet *tileset, TCUpload upload ) { return 0; }
/**
 *  \brief
 ...
 */
s16 TC_reAlloc( TileCache *cache, TileSet *tileset ) { return 0; }
 ...
 *      -1 if not found.
 */
s16 TC_getTileIndex( TileCache *cache, TileSet *tileset ) { return 0; }
